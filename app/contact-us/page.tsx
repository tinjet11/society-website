    ...
    <>
      <div className="container">
        ...
        <div className="flex flex-col">
          ...
          <div className="px-6">
            <h1 className='title-header'>Want to <span className='text-[#E981D9]'>Collaborate?</span></h1>
          ...
          <div className="px-6">
            <h1 className='title-header'>How to <span className='title'>Reach</span> us?</h1>
